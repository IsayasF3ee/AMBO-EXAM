...
"AUTOMATA":[
  ...
  {
    "id": 1,
    "question": "The lexical analysis for a modern computer language such as Java needs the power of which machine model in a necessary and sufficient sense?",
    "options": {
    ...
    "answer": "A",
    "explanation": "Lexical analysis can be done with finite state automata, which are sufficient to recognize regular patterns like keywords, identifiers, and operators."
  },
  {
    "id": 2,
    ...
    "options": {
      ...
      "B": "Lexical analysis of the program",
      "C": "Code generation",
      "D": "Data flow analysis"
    },
    "answer": "B",
    "explanation": "Lexical analysis scans the source code and identifies tokens, including keywords, identifiers, and symbols."
  },
  {
    "id": 3,
    "question": "Which one of the following pairs has different expressive power?",
    "options": {
    ...
    "answer": "B",
    "explanation": "DPDA are strictly less powerful than NPDA. DFA and NFA have the same expressive power. Single-tape and multi-tape Turing machines are equivalent in terms of language recognition."
  },
  {
    "id": 4,
    "question": "Which one of the following problems is decidable?",
    "options": {
    ...
    "answer": "D",
    "explanation": "Recursive languages are decidable, so the question of membership in recursive languages is decidable. Other problems involve undecidable questions like the halting problem."
  },
  {
    "id": 5,
    "question": "Given the language L={ab, aa, baa}, which one of the following strings are in L?",
    "options": {
      "A": "abaabaaabaa",
      "B": "aaaabaaaa",
      "C": "baaaaabaaaab",
    ...
    "answer": "D",
    "explanation": "Only 'baaaaabaa' can be completely decomposed into concatenations of strings from L."
  },
  {
    "id": 6,
    "question": "What is the language generated by the grammar S→aSb, S→A, A→aA?",
    "options": {
      "A": "ambm",
      "B": "∅",
      "C": "anbm",
    ...
    "answer": "C",
    "explanation": "The grammar generates strings with n a's followed by n b's for n ≥ 1."
  },
  {
    "id": 7,
    "question": "(a, b)+ means?",
    "options": {
      ...
      "C": "Combination of a, b, but 'a' will come first",
      "D": "None of these"
    },
    "answer": "B",
    "explanation": "The '+' operator in regular expressions denotes one or more repetitions, so null (empty string) is excluded."
  },
  {
    "id": 8,
    "question": "What is the highest type number to the grammar given by the following production rule S→Aa, A→c|Ba, B→abc?",
    "options": {
      "A": "Zero",
      "B": "One",
      "C": "Two",
    ...
    "answer": "C",
    "explanation": "This grammar is context-sensitive (Type 1) because productions can increase string length and are not strictly linear."
  },
  {
    "id": 9,
    "question": "Which of the following errors will be handled by the operating system?",
    "options": {
    ...
    "answer": "D",
    "explanation": "Modern operating systems handle hardware errors like printer issues, power failures, and network errors."
  },
  {
    "id": 10,
    ...
    "answer": "A",
    "explanation": "Merge Sort works efficiently on linked lists because it does not require random access and has O(n log n) time complexity."
  },
  {
    "id": 11,
    "question": "Combinational circuit that receives 2^n input and directs it to a single output line is called?",
    "options": {
      "A": "Decoder",
      "B": "Encoder",
      "C": "Multiplexer",
    ...
    "answer": "C",
    "explanation": "A multiplexer selects one of the 2^n inputs to pass to the output based on select lines."
  },
  {
    "id": 12,
    "question": "The components of an intelligent agent are?",
    "options": {
    ...
    "answer": "B",
    "explanation": "An intelligent agent interacts with its environment through sensors and actuators and is evaluated by its performance measure."
  },
  {
    "id": 13,
  ...
  {
    "id": 14,
    "question": "Which of the following is used in application programs to request data from the operating system?",
    "options": {
      "A": "System calls",
      "B": "Libraries",
      "C": "Interrupts",
    ...
    "answer": "A",
    "explanation": "System calls provide the interface for application programs to interact with the OS to request resources or services."
  },
  {
    "id": 15,
    "question": "What is the output of: int x = 3; int y = 5; cout << (x == y);",
    "options": {
      "A": "1",
      "B": "0",
      "C": "true",
    ...
    "answer": "B",
    "explanation": "The expression (x == y) evaluates to false, which is represented as 0 in C++."
  },

  {
    "id": 15,
    "question": "Halting problem/language is more described as?",
    "options": {
    ...
    "answer": "C",
    "explanation": "The halting problem is recursively enumerable (RE) but not recursive, meaning it is semi-decidable but not decidable."
  },
  {
    "id": 16,
    "question": "Automata theory, computability theory, and complexity theory are all topics covered in the study of the theory of computation. Which of the following represents the main objective of complexity theory?",
    "options": {
      "A": "To classify problems as easy ones and hard ones",
      "B": "To classify problems by those that are solvable and those that are not solvable",
      "C": "To deal with definitions and properties of mathematical models of computation",
      "D": "All"
    },
    "answer": "A",
    "explanation": "Complexity theory focuses on classifying problems by their computational difficulty, i.e., easy (polynomial-time) vs. hard (NP-hard, NP-complete)."
  },
  {
    "id": 17,
    "question": "What is the language and grammar accepted by pushdown automata?",
    "options": {
    ...
    "answer": "B",
    "explanation": "Pushdown automata accept context-free languages, which correspond to type-2 grammars in the Chomsky hierarchy."
  },
  {
    "id": 18,
    "question": "Which of the following is the mechanism for simplifying the context-free grammar?",
    "options": {
      "A": "Eliminating useless symbols",
      "B": "Elimination of 𝜖-productions",
      "C": "Eliminating unit productions",
      "D": "All"
    },
    "answer": "D",
    "explanation": "Simplifying CFG involves removing useless symbols, 𝜖-productions, and unit productions."
  },
  {
    "id": 19,
    ...
    "answer": "C",
    "explanation": "The regex ensures that the string contains at least two '0's, possibly with other 0s or 1s anywhere in between."
  },
  {
    "id": 20,
    "question": "In computational complexity theory, a problem with decision making is said to be NP-complete when it is both in NP and NP-hard. What does NP mean?",
    "options": {
    ...
    "answer": "B",
    "explanation": "NP stands for Non-deterministic Polynomial time, meaning the solution can be verified in polynomial time."
  },
  {
    "id": 21,
    "question": "The grammar production: A→aB refers to which of the following forms?",
    "options": {
      "A": "Greibach Normal Form",
      "B": "Chomsky Normal Form",
      "C": "Backus Naur Form/CFG",
      "D": "None"
    },
    "answer": "A",
    "explanation": "Greibach Normal Form (GNF) has productions of the form A → aα where 'a' is a terminal and 'α' is a string of non-terminals."
  },
  {
    "id": 22,
    "question": "How many FAs exist that have 2 states and accept an empty string?",
    "options": {
      "A": "One",
      "B": "Two",
      "C": "Three",
    ...
    "answer": "A",
    "explanation": "With 2 states, only one configuration can accept the empty string: initial state is also accepting."
  },
  {
    "id": 23,
    "question": "Language which can be defined by FA is?",
    "options": {
      "A": "Regular Language",
      "B": "Non-regular language",
      "C": "May be regular or non-regular",
      "D": "Context-free language"
    },
    "answer": "A",
    "explanation": "Finite automata (FA) define only regular languages."
  },
  {
    "id": 24,
  ...
  {
    "id": 25,
    "question": "Regular expression for all strings starting with 'ab' and ending with 'bba' is:",
    "options": {
      "A": "aba*b*bba",
      "B": "ab(ab)*bba",
      "C": "ab(a+b)*bba",
    ...
    "answer": "C",
    "explanation": "The correct regex ab(a+b)*bba matches any string starting with 'ab', followed by any combination of a and b, ending with 'bba'."
  },
  {
    "id": 26,
    "question": "Which of the following is not an example of finite state machine system?",
    "options": {
      "A": "Mechanism of an elevator",
      "B": "Signal lights",
      "C": "Digital Watches",
      "D": "Microwave Ovens"
    },
    "answer": "D",
    "explanation": "Microwave ovens have complex control systems beyond simple FSMs."
  },
  {
    "id": 27,
    ...
    "answer": "B",
    "explanation": "An ambiguous grammar allows multiple parse trees for the same string."
  },
  {
    "id": 28,
    "question": "The production of the form nonterminal → one nonterminal is called the:",
    "options": {
      "A": "Null production",
      "B": "Nullable production",
      "C": "Unit production",
      "D": "Both B and C"
    },
    "answer": "C",
    "explanation": "Unit production is of the form A → B, where both sides are non-terminals."
  },
  {
    "id": 29,
    "question": "If there is a CFG for the language L that has no λ-productions, then there is also a CFG:",
    "options": {
      "A": "Having λ-production and no unit production",
      "B": "No λ-production but has unit production",
      "C": "No λ-production and no unit production",
      "D": "Both B and C"
    },
    "answer": "C",
    "explanation": "CFG can always be converted to a form with no λ-productions and no unit productions."
  },
  {
    "id": 30,
    "question": "A production in CFG consists of:",
    "options": {
      "A": "One terminal",
    ...
    "answer": "D",
    "explanation": "A CFG production consists of a combination of terminals and non-terminals on the right-hand side."
  },
  {
    "id": 31,
    "question": "A pushdown automaton employs ________ data structure.",
    "options": {
      "A": "Stack",
      "B": "Queue",
      "C": "Linked List",
    ...
    "answer": "A",
    "explanation": "Pushdown automata use a stack to store intermediate symbols."
  },
  {
    "id": 32,
    ...
    "answer": "B",
    "explanation": "Tractable problems can be solved in polynomial time, making them feasible."
  },
  {
    "id": 33,
    ...
    "answer": "C",
    "explanation": "The halting problem is a classic example of an undecidable problem."
  },
  {
    "id": 34,
    ...
    "answer": "D",
    "explanation": "The lexical analyzer (scanner) groups characters into meaningful tokens."
  },
  {
    "id": 35,
    ...
    "answer": "A",
    "explanation": "Bottom-up parsers generate the reverse of right-most derivations (canonical LR parsing)."
  },
  {
    "id": 36,
    "question": "The output of the lexical analyzer is ___",
    "options": {
      "A": "string character",
      "B": "a syntax tree",
      "C": "a set of RE",
    ...
    "answer": "D",
    "explanation": "The lexical analyzer outputs a set of tokens representing lexical units of the source code."
  },
  {
    "id": 37,
    "question": "If a grammar produces more than one leftmost derivation for a sentence, it is called as:",
    "options": {
      "A": "Ambiguous grammar",
      "B": "Perfect grammar",
    ...
    "answer": "A",
    "explanation": "Ambiguous grammars allow multiple leftmost derivations for the same string."
  },
  {
    "id": 38,
    "question": "The intersection of a context-free language and a regular language is________",
    "options": {
      "A": "context-free",
    ...
    "answer": "A",
    "explanation": "The intersection of a context-free language with a regular language is always context-free."
  },
  {
    "id": 39,
    "question": "Which one of the following is not part of a Turing machine?",
    "options": {
      "A": "Finite control",
      "B": "Input",
      "C": "Tape",
    ...
    "answer": "B",
    "explanation": "Input itself is not a component; the Turing machine operates on tape using finite control and head."
  },
  {
    "id": 40,
    "question": "Which of the following is the true production rule grammar in language L(G) = {bnan+1: n ≥ 0}?",
    "options": {
      "A": "P: S -> Ab, S -> aSb, A -> ε",
      "B": "P: S -> Aa, S -> bSa, A -> ε",
      "C": "P: S -> Ab, A -> bS, A -> a",
    ...
    "answer": "A",
    "explanation": "The grammar P: S -> Ab, S -> aSb, A -> ε correctly generates strings with n b’s followed by n+1 a’s."
  },

  {
    "id": 41,
    "question": "Which of the following represents all strings of 0’s and 1’s starting with 0 and ending with 1?",
    "options": {
      "A": "0(0+1)*1",
      "B": "0(0+1*)1",
      "C": "0(01)*1",
    ...
    "answer": "A",
    "explanation": "The regex 0(0+1)*1 matches all strings starting with 0 and ending with 1, with any combination of 0s and 1s in between."
  },
  {
    "id": 42,
    "question": "Which of the following is true for resolving ambiguity in grammar?",
    "options": {
      "A": "Rewrite the grammar to resolve ambiguity explicitly",
      "B": "Add a meta-rule using precedence and associativity rules",
      "C": "Redesign the language to remove the ambiguity",
      "D": "All"
    },
    "answer": "D",
    "explanation": "Ambiguity in grammar can be resolved by rewriting the grammar, adding precedence/associativity rules, or redesigning the language."
  },
  {
    "id": 43,
    "question": "TM is a mathematical model which consists of an infinite length tape divided into cells on which input is given.",
    "options": {
      "A": "Automata Machine",
      "B": "Pushdown Automata",
      "C": "Turing Machine",
    ...
    "answer": "C",
    "explanation": "A Turing Machine is a mathematical model with an infinite tape divided into cells to perform computations."
  },
  {
    "id": 44,
    "question": "An abstract model of a digital computer to self-operating machine is called?",
    "options": {
      "A": "Language",
      "B": "Grammar",
      "C": "Automata",
    ...
    "answer": "C",
    "explanation": "Automata theory studies abstract models of computing machines, like finite automata and Turing machines."
  },
  {
    "id": 45,
    "question": "Which of the following statements is incorrect?",
    "options": {
      "A": "Context-free grammar is a subset of Regular grammar",
      "B": "Regular grammar helps to generate regular sets",
      "C": "Turing machine is a type of automata",
      "D": "A language is regular if there is an automaton that accepts it"
    },
    "answer": "A",
    "explanation": "Regular grammar is a subset of context-free grammar, not the other way around."
  },
  {
    "id": 46,
    "question": "The set of all strings over {a,b} having exactly 3 b’s is represented by which regular expression?",
    "options": {
      "A": "a*ba*ba*ba*",
      "B": "ba*ba*b",
      "C": "a*ba*ba*b",
    ...
    "answer": "A",
    "explanation": "a*ba*ba*ba* ensures exactly 3 b's appear anywhere in the string, with any number of a's around them."
  },
  {
    "id": 47,
    "question": "Which of the following is false about context–free grammar?",
    "options": {
      "A": "Left and right linear grammar are context-free grammars",
      "B": "Regular grammar is not context-free grammar",
      "C": "Simple grammar is context-free grammar",
      "D": "Linear grammar is context-free grammar"
    },
    "answer": "B",
    "explanation": "All regular grammars are context-free grammars; thus statement B is false."
  },
  {
    "id": 48,
    "question": "The function nil(abab) is equal to?",
    "options": {
      "A": "abba",
      "B": "abab",
      "C": "λ",
    ...
    "answer": "C",
    "explanation": "The 'nil' function applied to any string returns the empty string λ."
  },
  {
    "id": 49,
    "question": "______ is a theoretical construct of Turing machine that can simulate any other Turing machine.",
    "options": {
      "A": "Multi-tape Turing machine",
      "B": "Universal Turing machine",
      "C": "Multi-track Turing machine",
      "D": "Semi-infinite Tape"
    },
    "answer": "B",
    "explanation": "A Universal Turing Machine can simulate any other Turing machine by reading its description and input."
  },
  {
    "id": 50,
    "question": "Which of the following is a characteristic of a non-deterministic finite automaton (NFA)?",
    "options": {
      "A": "An NFA requires a stack to store its state transitions.",
      "B": "An NFA can only recognize regular languages.",
      "C": "An NFA can have multiple possible transitions for a given input symbol and current state.",
      "D": "An NFA can recognize context-free languages"
    },
    "answer": "C",
    "explanation": "An NFA allows multiple possible transitions for a given input symbol in a given state, unlike a DFA."
  },
  {
    "id": 51,
    "question": "Which of the following best describes the halting problem for Turing machines?",
    "options": {
      "A": "Determining whether a given Turing machine will eventually halt or run indefinitely on a specific input.",
      "B": "Determining whether a given Turing machine can recognize context-free languages.",
      "C": "Determining whether a given Turing machine can simulate other computational models.",
      "D": "Determining whether a given Turing machine can solve any computational problem."
    },
    "answer": "A",
    "explanation": "The halting problem asks whether a Turing machine will halt on a given input or run forever, and is undecidable."
  },
  {
    "id": 52,
    "question": "Which regular expression represents strings over {0, 1} containing at least one '0' and at least one '1'?",
    "options": {
      "A": "0+1",
      "B": "0+1+",
      "C": "0*10*",
    ...
    "answer": "B",
    "explanation": "0+1+ ensures that the string contains at least one 0 and at least one 1."
  },
  {
    "id": 53,
    "question": "Which statement accurately describes a Turing machine's transition function?",
    "options": {
      "A": "Defines the initial state of the Turing machine.",
      "B": "Determines the number of steps the Turing machine can perform before halting.",
      "C": "Determines the input symbols accepted by the Turing machine.",
      "D": "Specifies the rules for changing the internal state and tape contents of the Turing machine."
    },
    "answer": "D",
    "explanation": "The transition function specifies how a Turing machine changes state and tape symbols based on current state and input."
  },
  {
    "id": 54,
    "question": "Which type of Turing machine has two tapes, one read-only and the other read-write?",
    "options": {
    ...
    "answer": "C",
    "explanation": "An offline Turing machine has one read-only input tape and one read/write working tape."
  },
  {
    "id": 55,
    "question": "_____ represents the class of problems that are at least as hard as the hardest problems in NP?",
    "options": {
      "A": "PSPACE",
      "B": "NP Complete",
      "C": "EXP",
    ...
    "answer": "D",
    "explanation": "NP-hard problems are at least as hard as the hardest problems in NP; they may or may not be in NP."
  },
  {
    "id": 56,
    "question": "What is the Turing Test in the context of AI?",
    "options": {
      "A": "A test to measure a machine's processing power",
      "B": "A test to evaluate the speed of AI algorithms",
      "C": "A test to measure a machine's ability to exhibit intelligent behavior indistinguishable from that of a human",
      "D": "A test for computer hardware performance"
    },
    "answer": "C",
    "explanation": "The Turing Test evaluates if a machine's behavior is indistinguishable from human intelligence."
  },
  {
    "id": 57,
    "question": "f(x) = x+2 over N is_____ function",
    "options": {
      "A": "Total",
      "B": "Partial",
      "C": "Recursive",
      "D": "Both total and partial"
    },
    "answer": "A",
    "explanation": "f(x) = x + 2 is defined for all natural numbers, so it is a total function."
  },
  {
    "id": 58,
    "question": "Which one of the following is concerned with the meaning of sentences in knowledge representation?",
    "options": {
      "A": "Structure",
      "B": "Syntax",
      "C": "Semantics",
      "D": "Computational aspect"
    },
    "answer": "C",
    "explanation": "Semantics deals with the meaning of sentences, while syntax deals with structure/form."
  },
  {
    "id": 59,
    "question": "Given input alphabet E={a, b, c, d} and empty string λ, which one of the following is not an element of E+?",
    "options": {
      "A": "b",
      "B": "abbccdd",
      "C": "λ",
    ...
    "answer": "C",
    "explanation": "E+ represents all strings formed from E with length ≥1; λ (empty string) is not included."
  },
  {
    "id": 60,
    "question": "One of the following grammars is correctly matched?",
    "options": {
    ...
    "answer": "A",
    "explanation": "The grammar generates strings with nested patterns and is context-free; it is not regular."
  },

  {
    ...
    "answer": "D",
    "explanation": "The set of all languages over an alphabet is the power set of all strings, which is uncountably infinite."
  },
  {
    "id": 62,
    "question": "There are ________ tuples in a finite state machine.",
    "options": {
      "A": "4",
      "B": "5",
      "C": "6",
    ...
    "answer": "B",
    "explanation": "A finite state machine is defined as a 5-tuple (Q, Σ, δ, q0, F)."
  },
  {
    "id": 63,
    "question": "Assume R is a relation on set A, aRb is partially ordered. Then a and b are ______",
    "options": {
      "A": "Reflexive",
      "B": "Transitive",
      "C": "Symmetric",
  ...
  {
    "id": 64,
    "question": "The minimum number of states required to recognize an octal number divisible by 3 is",
    "options": {
      "A": "1",
      "B": "3",
      "C": "5",
    ...
    "answer": "B",
    "explanation": "Modulo 3 requires 3 states corresponding to the remainder when divided by 3."
  },
  {
    "id": 65,
    "question": "Statement 1: Initial state of NFA is initial state of DFA. Statement 2: Final state of DFA will be every combination of final states of NFA.",
    "options": {
    ...
    "answer": "A",
    "explanation": "When converting an NFA to DFA, the DFA's initial state corresponds to the NFA's initial state, and DFA final states include all sets containing at least one NFA final state."
  },
  {
    "id": 66,
    "question": "An automaton that presents output based on previous state or current input is called?",
    "options": {
      "A": "Acceptor",
      "B": "Classifier",
      "C": "Transducer",
    ...
    "answer": "C",
    "explanation": "A transducer generates output based on current state and/or input."
  },
  {
    "id": 67,
    "question": "Which one is false about the role of parser in compiling process?",
    "options": {
      "A": "Parser attempts to correct or recover from few errors",
      "B": "Parser cannot perform context-free syntax analysis",
      "C": "Parser builds the parse tree",
      "D": "Parser produces appropriate error messages"
    },
    "answer": "B",
    "explanation": "Parsers perform context-free syntax analysis; statement B is false."
  },
  {
    "id": 68,
    "question": "Let L1 = {w ∈ {0,1}* | w has at least as many occurrences of 110’s as 011’s}. L2 = {w ∈ {0,1}* | w has at least as many occurrences of 000’s as 111’s}. Which of the following is correct?",
    "options": {
      "A": "L2 is regular",
    ...
    "answer": "D",
    "explanation": "These languages require counting occurrences in strings, which is beyond regular language capabilities."
  },
  {
    "id": 69,
    "question": "Given the productions: E → E * F | E + F | F, F → F – F | id. Which of the following is true?",
    "options": {
    ...
    "answer": "A",
    "explanation": "In standard arithmetic precedence, multiplication (*) has higher precedence than addition (+)."
  },
  {
    "id": 70,
    "question": "Which derivation does a top-down parser use while parsing an input string?",
    "options": {
    ...
    "answer": "B",
    "explanation": "Top-down parsers construct a parse tree using left-most derivation."
  },
  {
    "id": 71,
    "question": "All of the following are functions of semantic analysis except ______.",
    "options": {
    ...
    "answer": "E",
    "explanation": "Checking missing semicolons is part of syntax analysis, not semantic analysis."
  },
  {
    "id": 72,
    "question": "Which of the following features cannot be captured by context-free grammar?",
    "options": {
      "A": "Syntax of if-then-else statements",
      "B": "Syntax of recursive functions",
      "C": "A variable is declared before its use",
      "D": "Matching nested parentheses"
    },
    "answer": "C",
    "explanation": "Context-free grammars cannot enforce context-sensitive constraints such as variable declarations before use."
  },
  {
    "id": 73,
    "question": "The regular expression for strings of 0′s and 1′s with no two consecutive 0′s is:",
    "options": {
      "A": "(0+1)",
      "B": "(0+1)*",
      "C": "(0+1)(1+10)*",
    ...
    "answer": "C",
    "explanation": "The expression (0+1)(1+10)* ensures no two consecutive 0s appear in the string."
  },
  {
    "id": 74,
    "question": "Consider the grammar: S→FR, R→*S|€, F→id. In the predictive parsing table M, the entries M[S, id] and M[R, $] are respectively:",
    "options": {
      "A": "S→FR and R→€",
      "B": "S→FR and R→{}",
      "C": "S→FR and R→*S",
    ...
    "answer": "A",
    "explanation": "Predictive parsing table entries use the productions corresponding to the current symbol and input."
  },
  {
    "id": 75,
    "question": "Consider decision problems P₁ (decidable), P₂ (undecidable), P₃. Which is true?",
    "options": {
    ...
    "answer": "C",
    "explanation": "If an undecidable problem reduces to P₃, then P₃ must be undecidable."
  },
  {
    "id": 76,
    "question": "What type of languages do Turing machines generate?",
    "options": {
      "A": "Regular languages",
    ...
    "answer": "C",
    "explanation": "Turing machines generate recursively enumerable languages, which include all languages they can recognize."
  },
  {
    "id": 77,
    "question": "Which is true for NFA machine M to accept a string?",
    "options": {
      "A": "All symbols of input string must be scanned and all paths must end at accepting state",
      "B": "All symbols may not be scanned but must reach some accepting state",
      "C": "All symbols scanned and last state is non-accepting",
      "D": "All symbols scanned and one path must end at accepting state",
      "E": "None of these"
    },
    "answer": "D",
    "explanation": "An NFA accepts a string if at least one path consuming all input ends in an accepting state."
  },
  {
    "id": 78,
    "question": "The regular expression r = b*ab* + b* represents any string w over {a,b}:",
    "options": {
      "A": "Starting with b and having no other a’s or having only b’s",
      "B": "Having at least one a",
      "C": "Having at most one a",
      "D": "Starting with b and ending with a"
    },
    "answer": "C",
    "explanation": "The expression b*ab* + b* allows strings with at most one 'a'."
  },
  {
    "id": 79,
    "question": "A universal Turing machine is _______",
    "options": {
    ...
    "answer": "C",
    "explanation": "A Universal Turing Machine is reprogrammable to simulate any other Turing machine."
  },
  {
    "id": 80,
    "question": "Let X belong to NP. Which of the following is TRUE?",
    "options": {
      ...
      "E": "X may be undecidable"
    },
    "answer": "B",
    "explanation": "If an NP problem is solved in polynomial time deterministically, it proves P = NP."
  },
  {
    "id": 81,
    "question": "Machine learning is grouped under which generation of programming language?",
    "options": {
      "A": "3rd generation",
      "B": "1st generation",
      "C": "2nd generation",
    ...
    "answer": "D",
    "explanation": "Machine learning and higher-level declarative programming are considered 4th generation languages."
  },
  {
    "id": 82,
    "question": "Which of the following is false about Context–Free Grammar?",
    "options": {
      "A": "Context-free grammar is subset of Regular Grammar",
      "B": "Linear grammar is context-free grammar",
      "C": "Left Linear grammar is subset of context-free grammar",
      "D": "Left and right linear grammar are context-free grammars"
    },
    "answer": "A",
    "explanation": "Regular grammars are a subset of context-free grammars, not the reverse."
  },
  {
    "id": 83,
    "question": "The language processor that translates the program into object code is?",
    "options": {
      "A": "Linker",
      "B": "Debugger",
      "C": "Compiler",
    ...
    "answer": "C",
    "explanation": "Compilers translate high-level programs into object/machine code."
  },
  {
    "id": 84,
    "question": "Correct ordering in language processing system?",
    "options": {
      "A": "Source program → preprocessor → compiler → assembler → linker/loader → target machine code",
      ...
      "D": "Source program → preprocessor → compiler → assembler → linker/loader → target machine code"
    },
    "answer": "D",
    "explanation": "Language processing order: source program → preprocessor → compiler → assembler → linker/loader → target machine code."
  },
  {
    "id": 85,
    "question": "From the list of alternatives, identify the one which is different?",
    "options": {
    ...
    "answer": "D",
    "explanation": "Linear grammar may include left or right-linear, but not all linear grammars are regular."
  },
  {
    "id": 86,
    "question": "If a grammar is defined with G=(V,T,S,P), with A→x where A ∈ V, x ∈ (V∪T)*, the type of grammar is?",
    "options": {
    ...
    "answer": "D",
    "explanation": "A production A→x with single non-terminal on LHS is a context-free grammar production."
  },
  {
    "id": 87,
    "question": "What does 'P versus NP problem' refer to in computational complexity theory?",
    "options": {
      "A": "Distinguishing between parallel and non-parallel algorithms",
      "B": "Determining runtime of algorithms",
      "C": "Comparing efficiency of programming languages",
      "D": "Determining if certain problems have efficient algorithms"
    },
    "answer": "D",
    "explanation": "The P vs NP problem asks whether every problem whose solution can be verified in polynomial time can also be solved in polynomial time."
  },
  {
    "id": 88,
    "question": "Which complexity class includes problems solvable by a non-deterministic Turing machine in polynomial time?",
    "options": {
      "A": "P",
      "B": "NP",
      "C": "NP-complete",
    ...
    "answer": "B",
    "explanation": "NP is the set of decision problems solvable by a non-deterministic Turing machine in polynomial time."
  },
  {
    "id": 89,
    "question": "Which describes the relationship between formal languages, grammars, and automata?",
    "options": {
      "A": "Formal languages are generated by formal grammars, recognized by automata",
      "B": "Formal languages recognize automata, generated by grammars",
      "C": "Formal grammars generate automata, which recognize languages",
      "D": "Formal grammars recognize languages, which generate automata"
    },
    "answer": "A",
    "explanation": "Formal grammars generate languages, and automata recognize them."
  },
  {
    "id": 90,
    "question": "Which is an example of a formal language?",
    "options": {
      "A": "English",
      "B": "Spanish",
    ...
    "answer": "C",
    "explanation": "Formal languages are mathematically defined, e.g., using regular expressions or grammars."
  },
  {
    "id": 91,
  ...
  {
    "id": 92,
    "question": "Which statement is true regarding the Chomsky hierarchy?",
    "options": {
      "A": "Context-free languages are subset of regular languages",
      "B": "Context-sensitive languages are subset of recursive languages",
      "C": "Regular languages are subset of recursive languages",
      "D": "Context-free languages are subset of recursive languages"
    },
    "answer": "C",
    "explanation": "All regular languages are recursive and hence part of the recursive languages."
  },
  {
    "id": 93,
    "question": "Which is true regarding deterministic finite automata (DFAs)?",
    "options": {
      "A": "DFAs can recognize all regular languages",
      "B": "DFAs have multiple possible transitions for each input",
      "C": "DFAs can have empty transitions",
      "D": "DFAs can recognize context-free languages"
    },
    "answer": "A",
    "explanation": "DFAs recognize exactly the class of regular languages."
  },
  {
    "id": 94,
    "question": "Which automaton is more expressive than finite automaton but less powerful than Turing machine?",
    "options": {
    ...
    "answer": "A",
    "explanation": "Pushdown automata can recognize context-free languages, which DFAs cannot, but are less powerful than Turing machines."
  },
  {
    "id": 95,
    "question": "Which is an example of type coercion or type conversion?",
    "options": {
      "A": "Assigning a floating-point value to an integer variable",
      "B": "Assigning a value to an uninitialized variable",
      "C": "Declaring a variable without specifying type",
      "D": "Using an undeclared variable"
    },
    "answer": "A",
    "explanation": "Assigning a float to an int forces type conversion (coercion)."
  },
  {
    "id": 96,
    "question": "Which is true regarding NP-complete problems?",
    "options": {
      "A": "Only solvable by nondeterministic algorithms",
      "B": "Subset of NP problems",
      "C": "Can be solved in exponential time",
      "D": "Have no practical applications"
    },
    "answer": "B",
    "explanation": "NP-complete problems are a subset of NP problems and are both in NP and NP-hard."
  },
  {
    "id": 97,
    "question": "Which complexity class represents the hardest problems in NP?",
    "options": {
      "A": "P",
      "B": "NP-complete",
      "C": "NP-hard",
    ...
    "answer": "C",
    "explanation": "NP-hard problems are at least as hard as NP-complete problems; they represent the hardest problems in NP and beyond."
  },
  {
    "id": 98,
    "question": "Which is true regarding the halting problem?",
    "options": {
      "A": "Can be solved by a Turing machine",
      "B": "Decidable for all programs",
      "C": "Undecidable problem",
      "D": "Only relevant to regular languages"
    },
    "answer": "C",
    "explanation": "The halting problem is undecidable; no Turing machine can solve it for all inputs."
  },
  {
    "id": 99,
    ...
    "options": {
      "A": "{aⁿbⁿ | n ≥ 0}",
      "B": "{aⁿbⁿcⁿ | n ≥ 0}",
      "C": "{aⁿ | n is a prime number}",
      "D": "{aⁿb | n ≥ 0}"
    },
    "answer": "D",
    "explanation": "{aⁿb | n ≥ 0} can be represented by the regular expression a*b, hence it is regular."
  },
  {
    "id": 100,
    ...
    "answer": "B",
    "explanation": "Context-free grammars generate context-free languages, including languages like balanced parentheses."
  },

  {
    ...
    "options": {
      "A": "Every context-sensitive language is also a context-free language.",
      "B": "Every context-free language is also a context-sensitive language.",
      "C": "Context-free languages are a strict subset of context-sensitive languages.",
      "D": "Context-free languages are unrelated to context-sensitive languages."
    },
    "answer": "B",
    "explanation": "Every context-free language is context-sensitive, but not all context-sensitive languages are context-free."
  },
  {
    "id": 102,
    ...
    "answer": "C",
    "explanation": "Turing machines can recognize context-sensitive languages; pushdown automata cannot."
  },
  {
    "id": 103,
    ...
    "answer": "D",
    "explanation": "Recursively enumerable languages are those recognized by a Turing machine."
  },
  {
    "id": 104,
    ...
    "answer": "D",
    "explanation": "Recursively enumerable languages can be generated by unrestricted grammars (Turing machines), which is the most general class."
  },
  {
    "id": 105,
    ...
    "answer": "C",
    "explanation": "All recursive languages are recursively enumerable, but some recursively enumerable languages are not recursive."
  },
  {
    "id": 106,
    ...
    "answer": "D",
    "explanation": "The halting problem is undecidable for Turing machines."
  },
  {
    "id": 107,
    ...
    "options": {
      ...
      "C": "{wwᴿ | w is any string}",
      "D": "{aⁿb | n ≥ 0}"
    },
    "answer": "B",
    "explanation": "{aⁿ | n is prime} is not recursive and cannot be decided by a Turing machine."
  },
  {
    "id": 108,
    ...
    "answer": "B",
    "explanation": "Chomsky hierarchy classifies languages by their expressive power: regular, context-free, context-sensitive, recursively enumerable."
  },
  {
    "id": 109,
    "question": "Which type of grammar is used to generate the language L = {aⁿbⁿ | n ≥ 0}?",
    "options": {
      "A": "Regular grammar",
      "B": "Context-free grammar",
      "C": "Context-sensitive grammar",
    ...
    "answer": "B",
    "explanation": "The language {aⁿbⁿ | n ≥ 0} is context-free, not regular."
  },
  {
    "id": 110,
    ...
    "answer": "A",
    "explanation": "{aⁿbⁿ | n ≥ 0} is context-sensitive and also context-free."
  },
  {
    "id": 111,
    "question": "Which type of automaton is used to recognize the language L = {aⁿbⁿ | n ≥ 0}?",
    "options": {
      "A": "Finite automaton",
      "B": "Pushdown automaton",
      "C": "Turing machine",
    ...
    "answer": "B",
    "explanation": "Pushdown automata can recognize context-free languages like {aⁿbⁿ | n ≥ 0}."
  },
  {
    "id": 112,
    "question": "Which of the following grammars generates the language L = {wwᴿ | w is any string}?",
    "options": {
      "A": "Regular grammar",
      "B": "Context-free grammar",
      "C": "Context-sensitive grammar",
    ...
    "answer": "C",
    "explanation": "{wwᴿ | w ∈ Σ*} is context-sensitive but not context-free."
  },
  {
    "id": 113,
    "question": "Which type of automaton is used to recognize the language L = {wwᴿ | w is any string}?",
    "options": {
      "A": "Finite automaton",
      "B": "Pushdown automaton",
      "C": "Turing machine",
    ...
    "answer": "C",
    "explanation": "Turing machines can recognize languages that are context-sensitive like {wwᴿ}."
  },
  {
    "id": 114,
    "question": "Which type of grammar is used to generate the language L = {0ⁿ1ⁿ2ⁿ | n ≥ 0}?",
    "options": {
      "A": "Regular grammar",
      "B": "Context-free grammar",
      "C": "Context-sensitive grammar",
    ...
    "answer": "C",
    "explanation": "{0ⁿ1ⁿ2ⁿ} requires context-sensitive grammar as it is not context-free."
  },
  {
    "id": 115,
    "question": "Which type of automaton is used to recognize the language L = {0ⁿ1ⁿ2ⁿ | n ≥ 0}?",
    "options": {
      "A": "Finite automaton",
      "B": "Pushdown automaton",
      "C": "Turing machine",
    ...
    "answer": "C",
    "explanation": "Turing machines can recognize {0ⁿ1ⁿ2ⁿ}, which pushdown automata cannot."
  },
  {
    "id": 116,
    "question": "Which type of grammar is used to generate the language L = {aⁿ | n is a prime number}?",
    "options": {
      "A": "Regular grammar",
      "B": "Context-free grammar",
      "C": "Context-sensitive grammar",
    ...
    "answer": "D",
    "explanation": "Prime number language is not context-sensitive; it requires unrestricted grammar (Turing machine)."
  },
  {
    "id": 117,
    "question": "Which type of automaton is used to recognize the language L = {aⁿ | n is a prime number}?",
    "options": {
      "A": "Finite automaton",
      "B": "Pushdown automaton",
      "C": "Turing machine",
    ...
    "answer": "C",
    "explanation": "Turing machines can recognize this non-regular, non-context-free language."
  },
  {
    "id": 118,
    "question": "Which type of grammar is used to generate the language L = {aⁿb | n ≥ 0}?",
    "options": {
      "A": "Regular grammar",
      "B": "Context-free grammar",
      "C": "Context-sensitive grammar",
    ...
    "answer": "A",
    "explanation": "{aⁿb} is regular and can be generated by a regular grammar."
  },
  {
    "id": 119,
    ...
    "answer": "A",
    "explanation": "Class P contains problems solvable deterministically in polynomial time."
  },
  {
    "id": 120,
...
[
  {
    "id": 151,
    "question": "What is the role of a formal grammar in relation to a formal language?",
    "options": {
      "A": "It specifies the syntax and semantics of the language.",
      "B": "It defines the alphabet and rules for generating valid strings in the language.",
      "C": "It provides a set of keywords and operators for the language.",
      "D": "It determines the types and data structures used in the language."
    },
    "answer": "B",
    "explanation": "Formal grammar defines the set of rules and alphabet to generate all valid strings of a language."
  },
  {
    "id": 152,
    "question": "Which class of formal languages is defined by regular expressions and can be recognized by finite automata?",
    "options": {
      "A": "Regular languages",
      "B": "Context-free languages",
      "C": "Context-sensitive languages",
    ...
    "answer": "A",
    "explanation": "Regular languages are exactly those recognized by finite automata and defined by regular expressions."
  },
  {
    "id": 153,
    "question": "Which of the following is a valid example of a context-free grammar production rule?",
    "options": {
      "A": "A -> aBa",
      "B": "AB -> BA",
      "C": "A -> ε",
    ...
    "answer": "C",
    "explanation": "Context-free grammar rules have a single non-terminal on the left; A->ε is valid. A->aBa is also valid, but C is simpler and correct."
  },
  {
    "id": 154,
    ...
    "answer": "C",
    "explanation": "Type checking ensures that operations are applied to compatible data types according to language rules."
  },
  {
    "id": 155,
    "question": "Which complexity class represents the set of problems for which a solution can be verified in polynomial time on a non-deterministic Turing machine?",
    "options": {
      "A": "P",
      "B": "NP",
      "C": "PSPACE",
    ...
    "answer": "B",
    "explanation": "NP problems can be verified in polynomial time by a non-deterministic Turing machine."
  },
  {
    "id": 156,
    "question": "What is the relationship between P and NP complexity classes?",
    "options": {
      "A": "P = NP",
      "B": "P ⊂ NP",
      "C": "NP ⊂ P",
    ...
    "answer": "B",
    "explanation": "All problems in P are also in NP (verifiable in polynomial time), so P ⊆ NP."
  },
  {
    "id": 157,
    "question": "Which technique is commonly used for syntax analysis in compilers?",
    "options": {
    ...
    "answer": "A",
    "explanation": "Syntax analysis generates abstract syntax trees (ASTs) to represent the structure of source code."
  },
  {
    "id": 158,
    "question": "Which phase of the compiler ensures the correctness of the program's logic, such as type compatibility, scoping rules, and other language-specific rules?",
    "options": {
      "A": "Lexical Analysis",
      "B": "Semantic Analysis",
    ...
    "answer": "B",
    "explanation": "Semantic analysis checks logical correctness, type checking, and scope rules."
  },
  {
    "id": 159,
    "question": "Which technique is commonly used for lexical analysis in compilers?",
    "options": {
      "A": "Finite Automata",
      "B": "Backtracking",
    ...
    "answer": "A",
    "explanation": "Lexical analyzers use finite automata to recognize tokens in the source code."
  },
  {
    "id": 160,
    "question": "Which of the following best describes the role of a compiler?",
    "options": {
      "A": "Translates high-level programming languages to machine code",
      "B": "Executes programs and produces output",
      "C": "Provides an integrated development environment",
      "D": "Analyzes and detects runtime errors in the program"
    },
    "answer": "A",
    "explanation": "A compiler translates high-level code into low-level machine code or intermediate code."
  },
  {
    "id": 161,
    "question": "What does semantic analysis in compiler design primarily focus on?",
    "options": {
      "A": "Translating the program into an intermediate representation",
      "B": "Checking type compatibility and performing type inference",
      "C": "Transforming the program to improve its efficiency",
      "D": "Generating the target machine code"
    },
    "answer": "B",
    "explanation": "Semantic analysis verifies that the program obeys language rules, e.g., types and scoping."
  },
  {
    "id": 162,
    "question": "What is type checking in compiler design?",
    "options": {
      "A": "A process of verifying the syntax of the input program",
      "B": "A technique to optimize the generated machine code",
      "C": "An analysis to ensure the compatibility and correctness of data types",
      "D": "A step to generate intermediate code for the program"
    },
    "answer": "C",
    "explanation": "Type checking ensures data types are used consistently according to language rules."
  },
  {
    "id": 164,
    ...
    "answer": "A",
    "explanation": "Syntax analysis (parsing) builds the parse tree before semantic analysis."
  },
  {
    "id": 165,
    ...
    "answer": "A",
    "explanation": "Assembly language is machine-dependent, not machine-independent."
  },
  {
    "id": 166,
    "question": "Which one of the following is used for the purpose of syntax analysis?",
    "options": {
      "A": "Loader",
      "B": "Scanner",
      "C": "Linker",
    ...
    "answer": "D",
    "explanation": "Parser performs syntax analysis by checking grammatical structure."
  },
  {
    "id": 167,
    "question": "Which phase of compiling process is considered as the final phase in the process?",
    "options": {
      "A": "Code optimization",
      "B": "Code generation",
      "C": "Semantic analysis",
    ...
    "answer": "B",
    "explanation": "Code generation produces the final target machine code, completing compilation."
  },
  {
    "id": 168,
    "question": "Which one of the following is not high-level language?",
    "options": {
      "A": "C++",
      "B": "Java",
      "C": "Python",
    ...
    "answer": "D",
    "explanation": "Assembly is a low-level language, not high-level."
  },
  {
    "id": 169,
    "question": "Which of the following generation that stated for the high level languages like C++, Java, Python?",
    "options": {
      "A": "2nd generation",
      "B": "3rd generation",
      "C": "4th generation",
    ...
    "answer": "B",
    "explanation": "C++, Java, and Python are 3rd generation languages (3GL)."
  },
  {
    "id": 170,
    "question": "Which of the following generation that stated for interpreted language such like SQL?",
    "options": {
      "A": "4th generation",
      "B": "2nd generation",
      "C": "3rd generation",
    ...
    "answer": "A",
    "explanation": "SQL is a 4th generation language (4GL), designed to be closer to human logic and more declarative."
  },
  {
    "id": 171,
    "question": "Which one of the following is a type of compiler which compiles only the changed lines from source code and updates the object code accordingly?",
    "options": {
    ...
    "answer": "C",
    "explanation": "Incremental compilers update only modified parts of the source code."
  },
  {
    "id": 172,
    "question": "Which technique of code optimization shifts computations from run time to compile time by evaluating constant expressions at compile time and replace the constant expressions by their values?",
    "options": {
      "A": "Copy propagation",
    ...
    "answer": "B",
    "explanation": "Compile-time evaluation (constant folding) computes constant expressions during compilation."
  },
  {
    "id": 173,
    "question": "Fortran, cool, lisp, c, c++, c#, and Java are grouped under.... generation of programming languages",
    "options": {
    ...
    "answer": "A",
    "explanation": "These are 3GL (third generation) high-level languages."
  },
  {
    "id": 174,
    "question": "Which one of the following is not the purpose of code optimization phase of the compiling process?",
    "options": {
    ...
    "answer": "B",
    "explanation": "Code optimization improves performance but should not change program behavior."
  },
  {
    "id": 175,
    "question": "Which program takes one or more object files generated by compiler or assembler and combines them into a single executable program?",
    "options": {
      "A": "Debugger",
      "B": "Linker",
      "C": "Loader",
    ...
    "answer": "B",
    "explanation": "The linker combines object files into a single executable."
  },
  {
    "id": 176,
    "question": "Which one of the following is not an example of programming language?",
    "options": {
      "A": "C++",
      "B": "Java",
      "C": "Assembly language",
    ...
    "answer": "C",
    "explanation": "Assembly language is considered a low-level language, not a high-level programming language."
  },
  {
    "id": 177,
    ...
    "answer": "C",
    "explanation": "Syntax analysis produces an abstract syntax tree (AST) representing program structure."
  }
